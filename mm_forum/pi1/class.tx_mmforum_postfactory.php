...
class tx_mmforum_postfactory {
	 ...
	 * @return  void
	 */
	function updateQueue_addTopic($topic_uid) {
		$this->updateQueue['topics'][$topic_uid] = true;
	}
	 ...
	 * @return  void
	 */
	function updateQueue_addForum($forum_uid) {
		$this->updateQueue['forums'][$forum_uid] = true;
	}
	 ...
	 * @return  void
	 */
	function updateQueue_addUser($user_uid) {
		$this->updateQueue['users'][$user_uid] = true;
	}
