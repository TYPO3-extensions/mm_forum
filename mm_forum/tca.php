...
$TCA['tx_mmforum_forums'] = array (
	...
	'columns'       => array (
		...
		'forum_name'    => array (		
			'exclude'       => 1,		
			'label'         => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_forums.forum_name',		
			'config'        => array (
				'type'          => 'input',	
				'size'          => '30',
			)
		...
		'forum_desc'    => array (		
			'exclude'       => 1,		
			'label'         => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_forums.forum_desc',		
			'config'        => array (
				'type'          => 'input',	
				'size'          => '30',
			)
		...
		'forum_posts'   => array (		
			'exclude'       => 1,		
			'label'         => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_forums.forum_posts',		
			'config'        => array (
				'type'          => 'input',	
				'size'          => '8',
				'eval'          => 'int',
		...
		'forum_last_post_id' => array (		
			'exclude'       => 1,		
			'label'         => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_forums.forum_last_post_id',
			'config'        => array(
				'type'          => 'group',
				'internal_type' => 'db',
		...
		'forum_order'   => array (		
			'exclude'       => 1,		
			'label'         => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_forums.forum_order',		
			'config'        => array (
				'type'          => 'input',	
				'size'          => '4',
				'max'           => '4',
		...
		'forum_topics'  => array (		
			'exclude'       => 1,		
			'label'         => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_forums.forum_topics',
			'config'        => array (
				'type'          => 'input',	
				'size'          => '8',
				'eval'          => 'int',
	...
	'types'         => array (
		'0'             => array('showitem' => 'hidden;;1;;1-1-1, forum_name, forum_desc, parentID, forum_last_post_id, forum_topics, forum_posts, grouprights_read, grouprights_write, grouprights_mod')
	),
	'palettes'      => array (
		'1'             => array('showitem' => '')
	)
...
$TCA['tx_mmforum_topics'] = array (
	...
	'columns'       => array (
		...
		'topic_title' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_topics.topic_title',		
			'config' => array (
				'type' => 'input',	
				'size' => '30',
			)
		...
		'topic_poster' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_topics.topic_poster',		
			'config' => array(
				'type' => 'group',
				'internal_type' => 'db',
				'allowed' => 'fe_users',
		...
		'topic_time' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_topics.topic_time',		
			'config' => array (
				'type' => 'input',
				'size' => '12',
				'max' => '20',
		...
		'topic_views' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_topics.topic_views',		
			'config' => array (
				'type' => 'input',	
				'size' => '6',
				'eval' => 'int',
		...
		'topic_replies' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_topics.topic_replies',		
			'config' => array (
				'type' => 'input',	
				'size' => '6',
				'eval' => 'int',
		...
		'topic_last_post_id' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_topics.topic_last_post_id',		
			'config' => array(
				'type' => 'group',
				'internal_type' => 'db',
				'allowed' => 'tx_mmforum_posts',
		...
		'forum_id' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_topics.forum_id',		
			'config' => array(
				'type' => 'group',
				'internal_type' => 'db',
				'allowed' => 'tx_mmforum_forums',
		...
		'topic_first_post_id' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_topics.topic_first_post_id',
			'config' => array(
				'type' => 'group',
				'internal_type' => 'db',
				'allowed' => 'tx_mmforum_posts',
        ...
        'shadow_tid' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_topics.shadow_tid',		
			'config' => array(
				'type' => 'group',
				'internal_type' => 'db',
        ...
        'shadow_fid' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_topics.shadow_fid',		
			'config' => array(
				'type' => 'group',
				'internal_type' => 'db',
				'allowed' => 'tx_mmforum_forums',
	...
	'types' => array (
		'0' => array('showitem' => 'hidden;;1;;1-1-1, topic_title,topic_poster,forum_id,topic_time,topic_views,topic_replies,topic_is,solved,at_top_flag,closed_flag,topic_first_post_id,topic_last_post_id,poll_id,shadow_tid,shadow_fid,tx_mmforumsearch_index_write')
	),
	'palettes' => array (
		'1' => array('showitem' => '')
	)
...
$TCA['tx_mmforum_posts'] = array (
	...
	'columns' => array (
		...
		'topic_id' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_posts.topic_id',		
			'config' => array(
				'type' => 'group',
				'internal_type' => 'db',
				'allowed' => 'tx_mmforum_topics',
		...
		'forum_id' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_posts.forum_id',
			'config' => array(
				'type' => 'group',
				'internal_type' => 'db',
				'allowed' => 'tx_mmforum_forums',
		...
		'poster_id' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_posts.poster_id',		
			'config' => array(
				'type' => 'group',
				'internal_type' => 'db',
				'allowed' => 'fe_users',
		...
		'post_time' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_posts.post_time',		
			'config' => array (
				'type' => 'input',
				'size' => '12',
				'max' => '20',
		...
		'poster_ip' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_posts.poster_ip',		
			'config' => array (
				'type' => 'input',	
				'size' => '30',
			)
		...
		'edit_time' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_posts.edit_time',		
			'config' => array (
				'type' => 'input',
				'size' => '12',
				'max' => '20',
		...
		'edit_count' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_posts.edit_count',		
			'config' => array (
				'type' => 'input',	
				'size' => '4',
				'max' => '4',
	...
	'types' => array (
		'0' => array('showitem' => 'hidden;;1;;1-1-1, topic_id, forum_id, poster_id, post_time, poster_ip, edit_time, edit_count, attachment, tx_mmforumsearch_index_write')
	),
	'palettes' => array (
		'1' => array('showitem' => '')
	)
...
$TCA['tx_mmforum_posts_text'] = array (
	...
	'columns' => array (
		...
		'post_text' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_posts_text.post_text',		
			'config' => array (
				'type' => 'text',
				'cols' => '30',
				'rows' => '5',
...
$TCA['tx_mmforum_smilies'] = array (
	...
	'columns' => array (
		...
		'code' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_smilies.code',		
			'config' => array (
				'type' => 'input',	
				'size' => '30',
			)
		...
		'smile_url' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_smilies.smile_url',		
			'config' => array (
				'type' => 'input',	
				'size' => '30',
			)
		...
		'emoticon' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_smilies.emoticon',		
			'config' => array (
				'type' => 'input',	
				'size' => '30',
			)
...
$TCA['tx_mmforum_mailkey'] = array (
	...
	'columns' => array (
		'code' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_mailkey.code',		
			'config' => array (
				'type' => 'input',	
				'size' => '30',
			)
...
$TCA['tx_mmforum_postsread'] = array (
	...
	'columns' => array (
		...
		'user' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_postsread.user',
			'config' => array(
				'type' => 'group',
				'internal_type' => 'db',
				'allowed' => 'fe_users',
		...
		'topic_id' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_postsread.topic_id',
			'config' => array(
				'type' => 'group',
				'internal_type' => 'db',
				'allowed' => 'tx_mmforum_topics',
...
$TCA['tx_mmforum_topicmail'] = array (
	...
	'columns' => array (
		...
		'user_id' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_topicmail.user_id',		
			'config' => array(
				'type' => 'group',
				'internal_type' => 'db',
				'allowed' => 'fe_users',
		...
		'topic_id' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_topicmail.topic_id',		
			'config' => array(
				'type' => 'group',
				'internal_type' => 'db',
				'allowed' => 'tx_mmforum_topics',
...
$TCA['tx_mmforum_favorites'] = array (
	...
	'columns' => array (
		...
		'user_id' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_favorites.user_id',
			'config' => array(
				'type' => 'group',
				'internal_type' => 'db',
				'allowed' => 'fe_users',
		...
		'topic_id' => array (		
			'exclude' => 1,		
			'label' => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_favorites.topic_id',
			'config' => array(
				'type' => 'group',
				'internal_type' => 'db',
				'allowed' => 'tx_mmforum_topics',
...
$TCA['tx_mmforum_polls'] = array(
    ...
    'columns'       => array(
        ...
        'endtime'       => array (		
			'exclude'       => 1,		
			'label'         => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_polls.endtime',
			'config'        => array (
				'type'          => 'input',
				'size'          => '12',
				'eval'          => 'datetime',
        ...
        'votes'         => array(
            'exclude'       => 1,
            'label'         => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_polls.votes',
            'config'        => array(
                'type'          => 'input',
                'size'          => '8',
                'eval'          => 'int'
...
$TCA['tx_mmforum_polls_answers'] = array(
    ...
    'columns'       => array(
        ...
        'poll_id'       => array (		
			'exclude'       => 1,		
			'label'         => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_polls_answers.poll_id',
			'config'        => array (
				'type'          => 'group',
                'internal_type' => 'db',
				'allowed'       => 'tx_mmforum_polls',
        ...
        'votes'         => array(
            'exclude'       => 1,
            'label'         => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_polls_answers.votes',
            'config'        => array(
                'type'          => 'input',
                'size'          => '8',
                'eval'          => 'int'
...
$TCA['tx_mmforum_polls_votes'] = array(
    ...
    'columns'       => array(
        ...
        'answer_id'       => array (		
			'exclude'       => 1,		
			'label'         => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_polls_votes.answer_id',
			'config'        => array (
				'type'          => 'group',
                'internal_type' => 'db',
        ...
        'user_id'         => array(
            'exclude'       => 1,
            'label'         => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_polls_votes.user_id',
            'config'        => array (
				'type'          => 'group',
                'internal_type' => 'db',
				'allowed'       => 'fe_users',
...
$TCA['tx_mmforum_ranks'] = array(
    ...
    'columns'       => array(
        ...
        'minPosts'         => array(
            'exclude'       => 1,
            'label'         => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_ranks.minPosts',
            'config'        => array(
                'type'          => 'input',
                'size'          => '8',
                'eval'          => 'int',
        ...
        'special'         => array(
            'exclude'       => 1,
            'label'         => 'LLL:EXT:mm_forum/locallang_db.php:tx_mmforum_ranks.special',
            'config'        => array(
                'type'          => 'check',
            )
        ),
