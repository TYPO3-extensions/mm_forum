 ...
 *  187:     function display_newCategory()
 *  258:     function display_editForum()
 *  344:     function display_editCategory()
 *  434:     function globalIncSorting($start,$amount=1,$parentId=0)
 *  448:     function getMaxSorting($parentId = 0)
 *  464:     function delete_category()
 *  492:     function delete_forum()
 *  517:     function delete_forumContents($fid)
 *  544:     function delete_forumIndex($fid)
 *  564:     function updateUserPosts()
 *  594:     function save_newForum()
 *  635:     function save_newCategory()
 *  674:     function save_editCategory()
 *  729:     function save_editForum()
 *  779:     function display_tree()
 *  868:     function getUserGroupAccess_field($fieldname,$value)
 *  913:     function getForumOrderField($row,$pid,$new=false,$sec='ctg')
 *  968:     function getLL($key)
 *  979:     function init()
 *
 * TOTAL FUNCTIONS: 21
