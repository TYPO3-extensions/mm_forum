 ...
 *
 *
 *   80: class tx_mmforum_install
 *
 *              SECTION: General module functions
 *  163:     function main()
 *  184:     function getLL($key)
 *  195:     function init()
 *  209:     function loadDefaultConfiguration()
 *
 *              SECTION: Content helper functions
 *  230:     function display_categoryLinks()
 *  252:     function display_helpForm()
 *
 *              SECTION: Main configuration form
 *  271:     function display_allConfigForm()
 *  383:     function getTextField($fieldname,$value,$size=64)
 *  397:     function getMD5Field($fieldname,$value)
 *  412:     function getCheckField($fieldname,$checked)
 *  429:     function getSelectField($fieldname,$value,$table,$pid,$limit)
 *  472:     function getGroupField($table,$value,$fieldname,$add_button=false,$add_pid=0)
 *
 *              SECTION: Installation
 *  516:     function display_installation()
 *  534:     function display_install_userGroups()
 *  570:     function display_install_storagePid()
 *  603:     function display_install_userPid()
 *
 *              SECTION: Saving
 *  640:     function save()
 *
 *              SECTION: Status detection
 *  690:     function getUserGroupsConfigured()
 *  708:     function getIsConfigured()
 *
 * TOTAL FUNCTIONS: 19
